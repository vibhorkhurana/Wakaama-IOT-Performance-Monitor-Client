 ...
 * object_test.c
 */
#define TEST_OBJECT_ID 3349

lwm2m_object_t * get_object_performance(void);
void free_object_performance(lwm2m_object_t * objectP);
uint8_t performance_change(lwm2m_data_t * dataArray, lwm2m_object_t * objectP);
void display_performance_object(lwm2m_object_t * objectP);
